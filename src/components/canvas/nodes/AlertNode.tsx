  ...
  return (
    <div
      className={`relative w-64 rounded-2xl border-2 bg-white p-4 transition-all duration-200 figma-shadow ${
        selected
          ? 'border-[#FF5B79] ring-4 ring-[#FF5B79]/20'
          : isPassed
          ? 'border-[#FF5B79] shadow-md shadow-[#FF5B79]/10'
    ...
    >
      ...
      <Handle
        ...
        className="!h-3.5 !w-3.5 !rounded-full !border-2 !border-white !bg-[#FF5B79] transition hover:!scale-125"
      />
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-100">
        ...
        <span className="rounded-full bg-rose-50 px-2 py-0.5 text-[11px] font-bold text-[#FF5B79] border border-rose-100">
          Toast
        </span>
      </div>
      ...
      <div className="mt-3 space-y-2 text-xs">
        <div className="rounded-xl bg-slate-50 p-2.5 border border-slate-100 text-slate-700">
